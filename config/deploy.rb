...
namespace :deploy do
  ...
  task :restart, :roles => :app, :except => { :no_release => true } do
    ...
    run "chmod 777 /home/embalao/rayco.bloomweb.co/app/config/database.php"
    run "cp /home/embalao/rayco.bloomweb.co/app/config/database.php.srvr /home/embalao/rayco.bloomweb.co/app/config/database.php"
    run "chmod 777 /home/embalao/rayco.bloomweb.co/app/tmp/ -R"
    run "chmod 777 /home/embalao/rayco.bloomweb.co/app/webroot/img/uploads/ -R"
    run "chmod 777 /home/embalao/rayco.bloomweb.co/app/webroot/files/uploads/ -R"
  end
